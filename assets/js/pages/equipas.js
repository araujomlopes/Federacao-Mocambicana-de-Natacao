...
async function loadSponsors() {
  const url =
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vTMKb7nNRenJu0293ElDZ7UYSe0bq-GVqU51hPjnheB1E7gD14KXvzwdGdn2VRlQ3vW_ev3nfxXL_4t/pub?gid=1241588928&single=true&output=csv';
  ...
  sponsors.forEach((s) => {
    const container = document.querySelector(`.team-sponsor[data-team="${s.team}"]`);
